...
export const navGroups: NavGroup[] = [
  ...
  { label: t("Portfolio", "Danh mục"), href: "/portfolio", items: [] },
  {
    ...
    items: [
      ...
      { label: t("RAI LLMs", "RAI LLMs"), href: "/llms" },
    ],
  },
  {
...
export const footerCols: FooterCol[] = [
  ...
  { title: t("Resources", "Tài nguyên"), links: [
    { label: t("Marketplace", "Marketplace"), href: "/marketplace" }, { label: t("Code", "Code"), href: "/code" }, { label: t("Apps", "Ứng dụng"), href: "/apps" }, { label: t("MCP Registry", "MCP Registry"), href: "/mcp" }, { label: t("Big Data", "Big Data"), href: "/bigdata" }, { label: t("RAI LLMs", "RAI LLMs"), href: "/llms" },
  ]},
